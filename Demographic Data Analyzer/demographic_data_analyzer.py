...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = round((len(bachelor)/len(df))*100, 1)
    ...
    high_salary_India = df[(df['salary'] == ">50K") & (df['native-country'] == "India")]['occupation'].value_counts()

    top_IN_occupation = high_salary_India.idxmax()
